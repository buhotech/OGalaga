...
In here lies the project description as provided by our professor, [Alexey Nikolaev](https://github.com/a-nikolaev), as well as the our project presentation ([PDF](<./OGalaga Presentation.pdf>)|[Google Slides](http://bit.ly/ogalaga)) and [technical write-up](<./OGalaga Report.pdf>).
